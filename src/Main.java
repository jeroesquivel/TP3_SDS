/**
 * Punto de entrada del simulador EDMD.
 *
 * Uso:
 *   java Main [opciones]
 *
 * Opciones:
 *   -N    <int>     Número de partículas          (default: 100)
 *   -tf   <double>  Tiempo final [s]              (default: 5.0)
 *   -o    <file>    Archivo de trayectoria        (default: output.txt)
 *   -s    <long>    Semilla aleatoria             (default: no fijar)
 *   -w    <int>     Escribir cada W eventos       (default: 1)
 *   --no-output     No escribir trayectoria       (benchmarks rápidos)
 *
 * Ejemplo:
 *   java Main -N 100 -tf 5.0 -o results/trayectoria.txt -s 42 -w 10
 */
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Long   seed       = null;
        int    writeEvery = 1;
        int    snapEvery  = 0;   // 0 = no snapshots
        ...
        // Nota: en colisiones PP elásticas en 2D, la velocidad INDIVIDUAL puede cambiar
        // (solo se conserva la energía cinética total). La velocidad individual SÍ se
        // conserva en colisiones con el obstáculo y el borde (pared fija).
        boolean ok = true;
        double totalKE = 0;
